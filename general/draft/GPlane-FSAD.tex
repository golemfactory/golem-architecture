...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm,angle=0]{./diag/Reference/MarketService-Reference.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm,angle=0]{./diag/Reference/ActivityService-Reference.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm,angle=0]{./diag/Reference/PaymentService-Reference.png}
