...
The schema file can be found in the `schemas/v1` folder and accessible at `https://schemas.golem.network/v1/certificate.schema.json`.
...
This schema defines the available permission control in the Golem network. It can be found in the `schemas/v1` folder or can be accessed at `https://schemas.golem.network/v1/permissions.schema.json`.
