...
The current implementation of the Network lacks decentralization in two key
areas:
...
query language can express only simple conditions on individual data points,
such as filtering for Offers with at least 2GB of RAM per core. A more robust
query language (e.g., XPath) for structured data would improve flexibility and
expressiveness.
